...
public class Queries {
    ...
    public void run() {
        ...
        createQuery("select new stricttest.Pair(p,a) from Person p join p.address a"); //"select new"
        createQuery("select new stricttest.Pair(p,p.address) from Person p join p.address a"); //"select new"
        createQuery("select new stricttest.Nil(p,a) from Person p join p.address a"); //error
        createQuery("select new stricttest.Pair(p) from Person p"); //error
        createQuery("select new stricttest.Pair(p,p.name) from Person p"); //error
